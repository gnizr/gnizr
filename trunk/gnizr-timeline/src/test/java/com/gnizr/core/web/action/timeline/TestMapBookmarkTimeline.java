...
public class TestMapBookmarkTimeline extends DatabaseTestCase {
	...
	public TestMapBookmarkTimeline(){
	...
	protected IDataSet getDataSet() throws Exception {
		return new FlatXmlDataSet(TestMapBookmarkTimeline.class.getResourceAsStream("/TestMapBookmarkTimeline-input.xml"));
	}
