...
public interface BookmarkFolderSchema {

	public static final String TABLE_NAME = "bookmark_folder";
	public static final String ID = TABLE_NAME + ".id";
	public static final String BOOKMARK_ID = TABLE_NAME + ".bookmar_id";
