...
/**
 * A FreeMarker function for tidying HTML code. 
 * @author Harry Chen
 * @since 2.4.0
 *
 */
public class TidyHtmlMethod implements TemplateMethodModelEx{

	private static final Logger logger = Logger.getLogger(TidyHtmlMethod.class);
	
	/**
	 * Fixes any bad HTML code. This function takes a single argument, and 
	 * which must be <code>StringModel</code> or <code>SimpleScalar</code>. When fixing the HTML code,
	 * this function pulls and returns the BODY element of the input and clean its children 
	 * elements. This function shouldn't be used to process a full HTML page. 
	 */
	...
	public Object exec(List args) throws TemplateModelException {
		...
		return FormatUtil.tidyHTML(htmlCode,true,"utf8");
	}
