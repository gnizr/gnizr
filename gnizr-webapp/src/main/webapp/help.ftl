...
<ul>
  ...
  <li>For users of Firefox: drag '<a href="javascript:function post2gnizr(url,title){window.open('${webApplicationUrl}/post?url='+encodeURIComponent(url)+'&title='+encodeURIComponent(title)+'&redirect=false&saveAndClose=true','gnizr','toolbar=no,width=800,height=640,alwaysRaised=yes,left=0,scrollbars=yes');location.href=url;}; post2gnizr(location.href,document.title);">post to gnizr</a>' up to your Bookmarks Toolbar.</li>
</ul>
